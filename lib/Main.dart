              ...
              children: [
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          Text(
                            '현재 페이지: $_currentPage 페이지 악보 이미지 내용',
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ElevatedButton.icon(
                        onPressed: widget.isLeader && _currentPage > 1
                      ...
                      const SizedBox(width: 24),
                      ElevatedButton.icon(
                        onPressed: widget.isLeader && _currentPage < _totalPage
                            ? () => setState(() => _currentPage++)
                            : null,
                        icon: const Icon(Icons.arrow_right),
                        label: const Text('다음 페이지'),
                      ),
                    ],
                  ),
                ),
